...
from beamng_sim.code_pipeline.validation import TestValidator
...
class Budget:
    ...
    def get_remaining_real_time(self):
        log.debug(f"Remaining real time budget: {self.time_budget - (time.perf_counter() - self.start_real_time)}")
